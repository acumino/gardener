...
func ValidateGardenletChartRBAC(ctx context.Context, c client.Client, expectedLabels map[string]string, serviceAccountName string, selfHostedShoot bool) {
	// ClusterRoles
	gardenletClusterRole := getGardenletClusterRole(expectedLabels, selfHostedShoot)
...
func getGardenletClusterRole(labels map[string]string, selfHostedShoot bool) *rbacv1.ClusterRole {
