...
type Options struct {
	*cmd.Options
	...
	// For shoot's worker with a single zone, this zone is automatically applied.
...
func (o *Options) addFlags(fs *pflag.FlagSet) {
	...
	fs.StringVarP(&o.Zone, "zone", "z", "", "Zone of the node in which this new node is being joined")
}
